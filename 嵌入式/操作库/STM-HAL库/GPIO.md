...
| 开漏输出 | GPIO 寄存器 | 仅 NMOS | [[../../../工程实践/STM-F103/铁头山羊-平衡小车/Lib/I2C]]、电平转换、线与总线 |
| 复用推挽 | 片上外设 | PMOS+NMOS | [[UART串口\|UART]] TX、[[SPI]] SCK/MOSI |
| 复用开漏 | 片上外设 | 仅 NMOS | [[../../../工程实践/STM-F103/铁头山羊-平衡小车/Lib/I2C]] SDA/SCL |
...
| 驱动能力 | 弱，上升沿慢 | 强，上升沿快 |
| 适用场景 | 按键等低速 | [[../../../工程实践/STM-F103/铁头山羊-平衡小车/Lib/I2C]] 等有严格时序要求 |
...
| [[../../../工程实践/STM-F103/铁头山羊-平衡小车/Lib/I2C]]（400KHz） | 2~10MHz | 总线速率不高 |
...
> 只要有一个设备拉低，整条线就是低。[[../../../工程实践/STM-F103/铁头山羊-平衡小车/Lib/I2C]] 利用此特性实现仲裁：主机发送 1 但读到 0，说明有其他设备在拉低，自动退出总线竞争，不会冲突。

### 软件 I2C 的 GPIO 配置

[[../../../工程实践/STM-F103/铁头山羊-平衡小车/Lib/I2C]] 的 SDA 线是双向的，发送和接收需要切换方向：
...
> [!example]- Q1：GPIO 有哪八种模式？[[../../../工程实践/STM-F103/铁头山羊-平衡小车/Lib/I2C]] 的 SDA/SCL 应该配置为什么模式？
...
> 内部上拉约 40KΩ，驱动弱；外部可用小阻值，驱动强。[[../../../工程实践/STM-F103/铁头山羊-平衡小车/Lib/I2C]] 等有时序要求的总线必须外部上拉，内部上拉太弱导致上升沿过慢。
